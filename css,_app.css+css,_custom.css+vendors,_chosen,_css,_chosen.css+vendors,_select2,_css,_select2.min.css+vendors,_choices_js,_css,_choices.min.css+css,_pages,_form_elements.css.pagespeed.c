...
.chosen-container-single .chosen-single abbr {
  ...
  width: 12px;
  height: 12px;
  background: url('vendors/chosen/css/chosen-sprite.png') -42px 1px no-repeat;
  font-size: 1px;
}
...
.chosen-container-single .chosen-single div b {
  ...
  width: 100%;
  height: 100%;
  background: url('vendors/chosen/css/chosen-sprite.png') no-repeat 0px 2px;
}
...
.chosen-container-single .chosen-search input[type="text"] {
  ...
  outline: 0;
  border: 1px solid #aaa;
  background: white url('vendors/chosen/css/chosen-sprite.png') no-repeat 100% -20px;
  background: url('vendors/chosen/css/chosen-sprite.png') no-repeat 100% -20px;
  font-size: 1em;
  font-family: sans-serif;
  line-height: normal;
  border-radius: 0;
...
.chosen-rtl .chosen-search input[type="text"] {
  ...
  background: white url('vendors/chosen/css/chosen-sprite.png') no-repeat -30px -20px;
  background: url('vendors/chosen/css/chosen-sprite.png') no-repeat -30px -20px;
  direction: rtl;
}
...
@media only screen and (-webkit-min-device-pixel-ratio: 1.5), only screen and (min-resolution: 144dpi), only screen and (min-resolution: 1.5dppx) {
  ...
  .chosen-container .chosen-results-scroll-up span {
    background-image: url('vendors/chosen/css/chosen-sprite%402x.png') !important;
