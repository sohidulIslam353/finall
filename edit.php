                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="" name="employeeid"  value="<?php echo $row->employeeid;?>" >
                                    </div>
                                </div>
                            </div>  
                            <div class="form-group row">
                    ...
                    <h5 class="heading">Account Login</h5>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-9 offset-sm-3">
                                    <button class="btn btn-primary layout_btn_prevent" type="submit" value="submit"> Update</button>
